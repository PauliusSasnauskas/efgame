...
export const BuildMineAction = { key: ['Numpad2', 'Digit2'], button: VanillaAction(mine, "Build Mine", 'pl-1.5'), req: buildingInfo['v:mine'].buildReq, allowOnTile: tileOwnedEmpty } as ConfigAction
export const BuildBarracksAction = { key: ['Numpad3', 'Digit3'], button: VanillaAction(barracks, "Build Barracks", 'pl-1.5'), req: buildingInfo['v:barracks'].buildReq, allowOnTile: tileOwnedEmpty } as ConfigAction
export const BuildTowerAction = { key: ['Numpad4', 'Digit4'], button: VanillaAction(tower, "Build Tower", 'pl-1.5'), req: buildingInfo['v:tower'].buildReq, allowOnTile: tileOwnedEmpty } as ConfigAction
export const BuildWoodWallAction = { key: ['Numpad5', 'Digit5'], button: VanillaAction(woodWall, "Build Wooden Wall", 'pl-1.5'), req: buildingInfo['v:woodwall'].buildReq, allowOnTile: tileOwnedEmpty } as ConfigAction
export const BuildStoneWallAction = { key: ['Numpad6', 'Digit6'], button: VanillaAction(stoneWall, "Build Stone Wall", 'pl-1.5 mb-4'), req: buildingInfo['v:stonewall'].buildReq, allowOnTile: tileOwnedEmpty } as ConfigAction
